...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    "👋 <b>𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐮𝐞 𝐬𝐮𝐫 𝐥𝐚 𝐩𝐥𝐚𝐭𝐞𝐟𝐨𝐫𝐦𝐞 𝐨𝐟𝐟𝐢𝐜𝐢𝐞𝐥𝐥𝐞 🔵 𝐂𝐚𝐬𝐡𝐁𝐞𝐭𝟒 🔵 𝐈𝐜𝐢, 𝐜𝐡𝐚𝐪𝐮𝐞 𝐦𝐞𝐦𝐛𝐫𝐞 𝐩𝐫𝐨𝐟𝐢𝐭𝐞 𝐝’𝐮𝐧 𝐬𝐮𝐢𝐯𝐢 𝐩𝐫𝐨𝐟𝐞𝐬𝐬𝐢𝐨𝐧𝐧𝐞𝐥, 𝐝’𝐮𝐧 𝐬𝐞𝐫𝐯𝐢𝐜𝐞 𝐫𝐚𝐩𝐢𝐝𝐞 𝐞𝐭 𝐝𝐞 𝐩𝐚𝐢𝐞𝐦𝐞𝐧𝐭𝐬 𝐬𝐞𝐜𝐮𝐫𝐢𝐬𝐞́𝐬.</b>\n"
    "━━━━━━━━━━━━━━━━━━━━━━━\n"
    ...
    "--------------------------------------------------\n"
    "🔷 <b>𝐍𝐨𝐭𝐞 𝐢𝐦𝐩𝐨𝐫𝐭𝐚𝐧𝐭𝐞 :</b>\n"
    "𝐏𝐨𝐮𝐫 𝐚𝐬𝐬𝐮𝐫𝐞𝐫 𝐥𝐚 𝐛𝐨𝐧𝐧𝐞 𝐫𝐞𝐜𝐞𝐩𝐭𝐢𝐨𝐧 𝐝𝐞 𝐯𝐨𝐬 𝐩𝐚𝐢𝐞𝐦𝐞𝐧𝐭𝐬, 𝐫𝐞𝐬𝐭𝐞𝐳 𝐚𝐛𝐨𝐧𝐧𝐞́ 𝐚̀ 𝐭𝐨𝐮𝐬 𝐥𝐞𝐬 𝐜𝐚𝐧𝐚𝐮𝐱 𝐣𝐮𝐬𝐪𝐮’𝐚̀ 𝐥𝐚 𝐜𝐨𝐧𝐟𝐢𝐫𝐦𝐚𝐭𝐢𝐨𝐧 𝐝𝐞 𝐯𝐨𝐭𝐫𝐞 𝐯𝐞𝐫𝐬𝐞𝐦𝐞𝐧𝐭 ✅\n"
    "--------------------------------------------------\n"
...
async def check_channels(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if all_subscribed:
        ...
        await context.bot.send_message(
            chat_id=user_id,
            text="✅Félicitation! Votre fidélité est récompensée.Un bonus de 2000𝗙𝗖𝗙𝗔  a été ajouté sur votre compte 𝗖𝗮𝘀𝗵 𝗕𝗲𝘁𝟰✅ ",
            reply_markup=keyboard
        )
    else:
        await context.bot.send_message(
